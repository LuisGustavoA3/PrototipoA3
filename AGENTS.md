...
- **Seja Direto:** Reduza preâmbulos como _"Olá, você poderia por favor me ajudar com..."_. Escreva diretamente o comando ou a dúvida.
- **Solicite apenas o necessário:** Se precisa apenas da correção de um bug, use instruções como: _"Corrija apenas a lógica condicional na linha X, sem explicar as mudanças"_.
