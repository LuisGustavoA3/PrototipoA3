...
export const Route = createFileRoute("/biblioteca-individuo")({
  head: () => ({
    meta: [
  ...
  component: BibliotecaIndividuo,
});

function BibliotecaIndividuo() {
  ...
  }, [individualContents, search, statusFilter]);
      ...
      >
        <div className="space-y-6 p-6">
          ...
          <section className="grid gap-4 lg:grid-cols-2">
            ...
            />
            <ProgressCard
              label="Progresso no eixo Indivíduo"
              value={individualProgress}
              description={`${individualProgress}% dos conteúdos finalizados`}
            />
          </section>
